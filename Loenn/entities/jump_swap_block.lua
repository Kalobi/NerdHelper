...
jumpSwapBlock.name = "NerdHelper/JumpSwapBlock"
jumpSwapBlock.nodeLimits = {1, 1}
jumpSwapBlock.fieldInformation = {
    theme = {
        options = enums.swap_block_themes,
        editable = false
    }
}
jumpSwapBlock.placements = {}
jumpSwapBlock.minimumSize = {16, 16}

for i, theme in ipairs(themes) do
    jumpSwapBlock.placements[i] = {
...
function jumpSwapBlock.sprite(room, entity)
    local sprites = {}
...
function jumpSwapBlock.nodeSprite(room, entity, node)
    local sprites = {}
...
function jumpSwapBlock.selection(room, entity)
    local nodes = entity.nodes or {}
    local x, y = entity.x or 0, entity.y or 0
    local nodeX, nodeY = nodes[1].x or x, nodes[1].y or y
    local width, height = entity.width or 8, entity.height or 8
